...
var _materialGreenCss = require("flatpickr/dist/themes/material_green.css");
...
(0, _notiflixDefault.default).Notify.info("Choose the date");
let dateToSelect = 0;
// flatpickr options
const options = {
    onOpen () {
    ...
    onClose (selectedDate) {
        ...
        if (selectedDate[0] < Date.now()) (0, _notiflixDefault.default).Notify.failure("Please choose a date in the future");
        else {
            (0, _notiflixDefault.default).Notify.success("Good!");
...
class Timer {
    ...
    start() {
        ...
        this.intervalId = setInterval(()=>{
            ...
            if (timeLeft <= 1000) {
                (0, _notiflixDefault.default).Notify.success("That is all");
                this.stop();
                return;
            }
        }, 1000);
...
function updateClockFace({ days , hours , minutes , seconds  }) {
    ...
    if (`${days}` != 00) {
        refs.daysEl.textContent = refs.counterBoxEl.firstElementChild.style.display = "flex";
        refs.daysEl.textContent = `${days}`;
    } else refs.counterBoxEl.firstElementChild.style.display = "none";
    if (`${hours}` != 00) {
        refs.hoursEl.textContent = refs.counterBoxEl.firstElementChild.nextElementSibling.style.display = "flex";
        refs.hoursEl.textContent = `${hours}`;
    } else refs.counterBoxEl.firstElementChild.nextElementSibling.style.display = "none";
    if (`${minutes}` != 00) {
        refs.minutesEl.textContent = refs.counterBoxEl.lastElementChild.previousElementSibling.style.display = "flex";
        refs.minutesEl.textContent = `${minutes}`;
    } else refs.counterBoxEl.lastElementChild.previousElementSibling.style.display = "none";
...
},{"flatpickr":"llQu5","flatpickr/dist/themes/material_green.css":"4ejuV","notiflix":"5WWYd","notiflix/dist/notiflix-3.2.5.min.css":"jvRD8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"4ejuV":[function() {},{}],"5WWYd":[function(require,module,exports) {
var global = arguments[3];
